...
interface RoomPosition {
  ...
  lookFor<T extends keyof AllLookAtTypes>(structureType: T): AllLookAtTypes[T][];
  ...
  findClosestByMultiRoomRange<T extends _HasRoomPosition>(objects: T[]): T | undefined | null;

  findClosestByRangeThenPath<T extends _HasRoomPosition>(objects: T[]): T | undefined | null;
}
