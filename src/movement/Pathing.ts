...
import { MatrixLib, VolatileMatrixOptions, getDefaultMatrixOptions, MatrixOptions } from "matrix/MatrixLib";
import { normalizePos } from "./helpers";
import { minBy, isAlly } from "utils/utils";
...
export class Pathing {
	...
	static nextDirectionInPath(creep: AnyBot): number | undefined {
	...
	static nextPositionInPath(creep: AnyBot): RoomPosition | undefined {
