...
Object.defineProperty(Room.prototype, 'isBrain', {
	get() {
		return BigBrain.brains[this.name] != undefined;
	},
	configurable: true,
});
...
Object.defineProperty(Room.prototype, 'reservedByMe', {
	get() {
		return this.controller && this.controller.reservation && this.controller.reservation.username == SETTINGS.MY_USERNAME;
	},
	configurable: true,
});
