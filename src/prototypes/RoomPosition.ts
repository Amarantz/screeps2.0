...
import { maxBy, minBy, mod } from "../utils/utils";
...
RoomPosition.prototype.findClosestByLimitedRange = function <T>(
  ...
  const objectsInRange = this.findInRange(objects as RoomPosition[], rangeLimit, opts);
...
RoomPosition.prototype.findClosestByRangeThenPath = function <T extends _HasRoomPosition>(objects: T[]): T | null {
