...
Object.defineProperty(StructureController.prototype, 'reservedByMe', {
	get         : function() {
		return this.reservation && this.reservation.username == SETTINGS.MY_USERNAME;
	},
	configurable: true,
});
...
Object.defineProperty(StructureController.prototype, 'signedByMe', {
	get         : function() {
		return this.sign && this.sign.username == SETTINGS.MY_USERNAME && Game.time - this.sign.time < 250000;
	},
	configurable: true,
});
...
StructureController.prototype.needsReserving = function(reserveBuffer: number): boolean {
	return !this.reservation || (this.reservedByMe && this.reservation.ticksToEnd < reserveBuffer) || this.reservation.username === 'Invader';
};
